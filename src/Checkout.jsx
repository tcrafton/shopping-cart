...
export default function Checkout({ emptyCart }) {
  ...
  function handleChange(e) {
    ...
    // 2. Use the input's id to determine which property
    //    to set (using the computed property syntax)
    // With functional set state, React deletes the event
    // before we can access it.
    // Solution: Persist the event.
    // tells React to persist the event, this isn't necessary in React 17 or newer since React 17 no longer pools events
    e.persist();
